...
export class ListingComponent implements OnInit {
  ...
  constructor(public service: MasterService, private alert: ToastrService, private router: Router, private modalservice: NgbModal) { }
  ...
  LoadInvoice() {
    ...
    // });
    console.log(this.service.invoiceheader)
  ...
  invoiceremove(invoiceno: any) {
    if(invoiceno){
      ...
      this.service.deleteinvoice(invoiceno);
      // this.alert.success('Removed Successfully.', 'Remove Invoice')
    }
  ...
  createInvoice(){
    this.service.iseditinvoice=false;
